...
public class ARPlacePrefab : MonoBehaviour
{
    ...
    public GameObject _placementGrid;
    void Start()
    {
        ...
        _placementIndicator = _placementGrid;
    ...
    {
        Vector3 newScale = _placedObject.transform.localScale + new
        Vector3(pinchDistanceChange, pinchDistanceChange, pinchDistanceChange) *
        pinchToScaleSensitivity;
